...
int opttest2(int dim, bool useGrad, nloptwr::SSTRAT sStrat=nloptwr::SSTRAT::L, int maxTimeSec=400)
{
    // return code
    int rc=0;
    ...
    // test
    bool isOk = opttest::fvcompare(minf, fOptExpcted, optWr.getX(), solution, 0.009);
    if (!isOk) {
        rc=1;
